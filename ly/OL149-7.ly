...
\relative { c''\breve*1/16 \hideNotes \breve*1/16 \bar "" \breve*1/16 \bar "" \breve*1/16 \bar "" \breve*1/16 \breve*1/16 \bar "" \unHideNotes b8 a \bar "" a g g g4 \cadenzaMeasure \bar "|" r8 a[( g8)] f \bar "" e[( d)] d2 \cadenzaMeasure \bar "||" \break }
...
\relative { c'4 e g8 g g g \bar "" a4 a b8 b b2 \cadenzaMeasure \bar "||" \break }
\relative { c''\breve*1/16 \hideNotes \breve*1/16 \bar "" \breve*1/16 \bar "" \breve*1/16 \bar "" \breve*1/16 \bar "" \breve*1/16 \breve*1/16 \bar "" \unHideNotes b8 a \bar "" a g g2 \cadenzaMeasure \bar "|" a\breve*1/16 \hideNotes \breve*1/16 \bar "" \unHideNotes g8 f \bar "" e d d d4 \cadenzaMeasure \bar "||" \break }
...
\set stanza = "1."
\left Ho -- \squash spo -- din mi -- lu -- je, co za -- lo -- žil na \unLeft \unSquash sva -- tých \markup \accent ho -- \star rách, \left mi -- \squash lu -- je brá -- ny Si -- ó -- nu nad všech -- na Ja -- ku -- \unLeft \unSquash bo -- va \markup \accent síd -- la.
\set stanza = "2."
...
\set stanza = "6."
\left Při \squash tan -- ci \unLeft \unSquash bu -- dou \markup \accent zpí -- \star vat: \left „Všech -- \squash na zříd -- la mé spá -- \unLeft \unSquash sy jsou \markup \accent "v to" -- bě.“
\set stanza = \responsum
Chval -- te Ho -- spo -- di -- na, všech -- ny ná -- ro -- dy! } }
    >>
    \layout {}
