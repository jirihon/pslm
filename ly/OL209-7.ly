...
\score {
    <<
        \new Voice = "melody" { \cadenzaOn \key es \major \relative { as'\breve*1/16 \hideNotes \breve*1/16 \bar "" \unHideNotes bes\breve*1/16 \hideNotes \breve*1/16 \bar "" \unHideNotes \bar "" g4 g4 \cadenzaMeasure \bar "|" r8 f es\breve*1/16 \hideNotes \breve*1/16 \bar "" \unHideNotes \bar "" g8 g4. \cadenzaMeasure \bar "||" \break } }
...
\score {
    <<
        \new Voice = "melody" { \cadenzaOn \key es \major \relative { r8 as'8 bes\breve*1/16 \hideNotes \breve*1/16 \breve*1/16 \bar "" \unHideNotes \bar "" g8 g r4 \cadenzaMeasure \bar "|" r8 f8 f\breve*1/16 \hideNotes \breve*1/16 \bar "" \unHideNotes es\breve*1/16 \hideNotes \breve*1/16 \bar "" \unHideNotes \bar "" g8 g g2 \cadenzaMeasure \bar "||" \break } }
        \new Lyrics \lyricsto "melody" { \lyricmode { \set stanza = "8."
Má \left du -- \squash še lne \unLeft \unSquash \markup \accent "k to" -- \star bě, tvá \left pra -- \squash vi -- \left \unLeft \unSquash ce \squash mě \unLeft \unSquash \markup \accent pod -- pí -- rá. } }
    >>
    \layout {}
}
