...
\leftText Spra -- \squashText ve -- dl -- nost jsem zvě -- sto -- val ve \unLeftText \unSquashText vel -- kém \markup \accent shro -- máž -- dě -- \star ní, svým \leftText rtům \squashText jsem ne -- brá -- \optionalBreath nil, ty \unLeftText \unSquashText to víš, \markup \accent Ho -- spo -- di -- ne! } }
    >>
    \layout {}
}
...
\score {
    <<
        \new Voice = "melody" { \cadenzaOn \key es \major \relative { r8 as'8 \squashNotes as\breve*1/16 \hideNotes \breve*1/16 \bar "" \breve*1/16 \bar "" \breve*1/16 \breve*1/16 \bar "" \unHideNotes \unSquashNotes bes8 f \bar "" as g g2 \cadenzaMeasure \bar "|" f8 \squashNotes c'\breve*1/16 \hideNotes \breve*1/16 \bar "" \unHideNotes \unSquashNotes d8 c \bar "" c bes bes4 \cadenzaMeasure \bar "||" \break } }
        \new Lyrics \lyricsto "melody" { \lyricmode { \set stanza = "5."
Nechť \leftText já -- \squashText sa -- jí a "v to" -- \unLeftText \unSquashText bě se \markup \accent ra -- du -- \star jí všich -- \leftText ni, \squashText kte -- \unLeftText \unSquashText ří tě \markup \accent hle -- da -- jí, } }
    >>
    \layout {}
}
