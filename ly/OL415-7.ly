...
\leftText Je -- \squashText stli -- že pad -- ne, ne -- zů -- sta -- ne \unLeftText \unSquashText \markup \accent le -- \star žet, \leftText pro -- \squashText to -- že mu Ho -- spo -- din pod -- pí -- rá \unLeftText \unSquashText \markup \accent ru -- ku. } }
    >>
    \layout {}
}
