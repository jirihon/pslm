...
\leftText Ne -- \squashText bu -- dou za -- han -- be -- ni "v do" -- bách \unLeftText \unSquashText \markup \accent ne -- ště -- \star stí, \leftText na -- \squashText sy -- tí se ve dnech \unLeftText \unSquashText \markup \accent hla -- du. } }
    >>
    \layout {}
}
