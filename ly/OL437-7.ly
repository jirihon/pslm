...
Ať \leftText oplý -- \squashText va -- jí \unLeftText \unSquashText mé rty \markup \accent chva -- lo -- zpě -- \star vem, \leftText žes \squashText mě na -- u -- \unLeftText \unSquashText čil svým \markup \accent pří -- ka -- zům. } }
    >>
    \layout {}
}
