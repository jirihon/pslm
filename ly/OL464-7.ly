...
\relative { es'8 es c es f es~ es4 \cadenzaMeasure \bar "|" as8 g4 f8 g as bes4 bes \cadenzaMeasure \bar "||" \break }
...
\relative { es'8 es c es f es~ es4 \cadenzaMeasure \bar "|" as8 g4 f8 g as bes4 bes \cadenzaMeasure \bar "||" \break } \bar "|." }
        \new Lyrics \lyricsto "melody" { \lyricmode { \set stanza = \responsum
Ho -- spo -- di -- ne, kdo smí prod -- lé -- vat ve tvém stán -- ku?
\set stanza = "1."
