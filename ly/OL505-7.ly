...
\score {
    <<
        \new Voice = "melody" { \cadenzaOn \key bes \major \relative { f'8 bes\breve*1/16 \hideNotes \breve*1/16 \bar "" \breve*1/16 \breve*1/16 \bar "" \unHideNotes a8 bes \bar "" c bes \bar "" a g \bar "" \bar "" g f f f4 \cadenzaMeasure \bar "||" \break } }
