...
\leftText Kaž -- \squashText dé -- mu "z nich" u -- \unLeftText \unSquashText hně -- tl \markup \accent srd -- \star ce, \leftText u -- \squashText va -- žu -- je o všech \unLeftText \unSquashText je -- jich \markup \accent skut -- cích. } }
    >>
    \layout {}
}
