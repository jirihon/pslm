...
\left Ať \squash je nad ná -- mi dob -- ro -- ti -- vost Pá -- na, na -- še -- ho \unLeft \unSquash \markup \accent Bo -- \star ha, \left dej \squash zdar prá -- ci na -- šich \unLeft \unSquash \markup \accent ru -- kou! } }
    >>
    \layout {}
}
