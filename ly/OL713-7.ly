...
\leftText Ra -- \squashText duj -- te se, spra -- ve -- \unLeftText \unSquashText dli -- ví, \markup \accent "z Ho" -- spo -- di -- \star na, \leftText slu -- \squashText ší se, a -- by ho \unLeftText \unSquashText dob -- ří \markup \accent chvá -- li -- li. } }
    >>
    \layout {}
}
