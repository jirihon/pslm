...
\leftText Ve \squashText svém srd -- ci u -- cho -- vá -- \unLeftText \unSquashText vám tvůj \markup \accent vý -- \star rok, \leftText a -- \squashText bych se ne -- pro -- hře -- šil \unLeftText \unSquashText pro -- ti \markup \accent to -- bě. } }
    >>
    \layout {}
}
