...
\leftText Dá -- \squashText vá sníh \unLeftText \unSquashText ja -- ko \markup \accent vl -- \star nu, \leftText jí -- \squashText ní sy -- pe \unLeftText \unSquashText ja -- ko \markup \accent po -- pel. } }
    >>
    \layout {}
}
