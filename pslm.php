...
function pslm_text_to_lyrics($text) {
    ...
    if ($PSLM_HYPH_EXCEPTIONS === null) {
        ...
        $search[] = '#(?<=[aáeéěiíoóuúůyý])(?=([bdďcčfghjklmnňpqrřsštťvwxzž]|ch|ct|chr|[hmst]l|[bkt]r|př|zř|jm|[sš]t|sv|vš)[aáeéěiíoóuúůyý])#ui'; // general pattern for two vowels separated by a consonant or consonant group
        $replace[] = ' -- ';
